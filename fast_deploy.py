...
def main():
 ...
 | |    | |/ _` | '_ \| | __| | | |    | '_ \ / _ \| |/ _ \ 
 | |____| | (_| | | | | | |_| | | |____| | | | (_) | |  __/
  \_____|_|\__, |_| |_|_|\__|_|  \_____|_| |_|\___/|_|\___|
            __/ |                                          
           |___/                                           
...
## Parser for help 
    # parser = argparse.ArgumentParser(description='Cigniti Chole a parameter discovery suite')
...
def index():
    ...
    print(url, sentences_count, apiKey)
    return summaries
...
# uvicorn fast_deploy:app --reload